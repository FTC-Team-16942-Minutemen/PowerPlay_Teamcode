...
public class SampleMecanumDrive extends MecanumDrive {
    public static PIDCoefficients TRANSLATIONAL_PID = new PIDCoefficients(6.0, 1, 0); //was 6.6
    public static PIDCoefficients HEADING_PID = new PIDCoefficients(6.0, 1, 0);

    public static double LATERAL_MULTIPLIER = 1.07;
    ...
    public SampleMecanumDrive(HardwareMap hardwareMap, Telemetry telemetry) {
        ...
        follower = new HolonomicPIDVAFollower(TRANSLATIONAL_PID, TRANSLATIONAL_PID, HEADING_PID,
                new Pose2d(0.1, 0.1 , Math.toRadians(0.2)), 0.0);
